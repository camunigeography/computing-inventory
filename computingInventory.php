	...
	public function databaseStructure ()
	{
		return "
			CREATE TABLE IF NOT EXISTS `administrators` (
			  `username__JOIN__people__people__reserved` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Username' PRIMARY KEY,
			  `active` enum('','Yes','No') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Yes' COMMENT 'Currently active?',
			  `editingStateMachines` text COLLATE utf8_unicode_ci COMMENT 'Fields to display',
			  `editingStateIpaddresses` text COLLATE utf8_unicode_ci COMMENT 'Fields to display'
			...
			CREATE TABLE IF NOT EXISTS `ipaddresses` (
			  ...
			  `ipAddress` varchar(40) COLLATE utf8_unicode_ci NOT NULL COMMENT 'IP address' UNIQUE KEY,
			  `reserved` enum('','Yes','No') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'No' COMMENT 'Whether the IP address is reserved'
			) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='IP addresses';
			
			CREATE TABLE IF NOT EXISTS `locations` (
			  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Automatic key' PRIMARY KEY,
			  `building` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Building name',
			  `floor` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Floor'
			) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Table of locations (buildings/floors)';
			...
			CREATE TABLE IF NOT EXISTS `machines` (
			  ...
			  `model` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Model',
			  `monitor` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Monitor',
			  `processor` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Processor',
			  `memory` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Memory',
			  `harddisk` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Hard disk',
			  `videocard` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Video card',
			  `networkcard` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Network card',
			  `locationId` int(11) DEFAULT NULL COMMENT 'Location',
			  `room` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Room',
			  `user` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'End user ID',
			  `os` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Operating system',
			  `sitevariable` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Site variable',
			  `image` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'OS image version',
			  `officeVersion` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Office version',
			  `adobeSoftware` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Adobe software',
			  `serialnumber` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Serial number',
			  `macaddress` varchar(17) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'MAC address',
			  `tag` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Tag',
			  `owner` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Owner',
			  ...
			  `decommisionedTo` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Decommisioned to',
			  `notes` text COLLATE utf8_unicode_ci COMMENT 'Notes'
			) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Table of machines';
			
			CREATE TABLE IF NOT EXISTS `templates` (
			  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Automatic key' PRIMARY KEY,
			  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Name for this profile',
			  `attribute` varchar(64) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Attribute',
			  `value` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Value'
			) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Table of machine template attributes';
			
			CREATE TABLE IF NOT EXISTS `types` (
			  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Automatic key' PRIMARY KEY,
			  `type` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Machine type'
			) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Machine types';
